...
- **Abnahmekriterien:**
  1. Vitest-Tests für `stockStatus` (leer, fehlt, reicht mit Soll, ohne Soll, Mindestbestand-Fälle) und für die Kontraste neuer Farbrollen.
